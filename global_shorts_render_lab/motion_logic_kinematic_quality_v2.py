...
# hero ball
bpy.ops.mesh.primitive_uv_sphere_add(segments=64,ring_count=32,radius=0.43,location=(0,-0.38,4.15))
...
bpy.ops.object.camera_add(location=(2.65,-13.2,0.65))
cam=bpy.context.object; scene.camera=cam
cam.data.type='ORTHO'; cam.data.ortho_scale=9.35
cam.rotation_euler=(Vector((0,0,-0.12))-cam.location).to_track_quat('-Z','Y').to_euler()

scene.frame_set(frame)
scene.render.filepath=os.path.join(outdir,f'quality_v2_{frame:04d}.png')
