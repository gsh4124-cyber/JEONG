...
# Hybrid camera language:
# 0.0-0.3s = whole machine + visible goal, then follow the active causal zone.
cam_key(1,0.75,-0.05,9.35)
cam_key(5,0.75,-0.05,9.35)
cam_key(8,3.10,2.70,7.70)
cam_key(14,2.75,2.20,7.05)
cam_key(24,1.05,0.50,6.85)
cam_key(36,-0.75,-1.40,6.55)
cam_key(46,-2.20,-2.95,6.30)
